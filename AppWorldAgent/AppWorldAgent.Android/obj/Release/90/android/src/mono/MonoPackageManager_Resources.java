...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "AppWorldAgent.Android.dll" comes first in this list. */
		"AppWorldAgent.Android.dll",
		"Acr.UserDialogs.dll",
		"AndHUD.dll",
		"AppWorldAgent.dll",
		"AppWorldAgent.Infrastructure.dll",
		"FormsViewGroup.dll",
		"Newtonsoft.Json.dll",
